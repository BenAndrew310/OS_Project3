...
#define AUTHOR "Benchley Andre 0616336"    //Change your name and student ID
MODULE_LICENSE("GPL");
...
static int initialize(void){
    ...
    if (strcmp(operationParam,"sum")==0) resultParam = firstParam + secondParam;
    else if (strcmp(operationParam,"sub")==0) resultParam = firstParam - secondParam;
    else if (strcmp(operationParam,"mul")==0) resultParam = firstParam * secondParam;
    else resultParam = 0;
